        ...
        <div className='w-[80%] mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[3rem]'>
            ...
            <div>
                ...
                <p className='mt-[2rem] text-black text-[17px] text-opacity-70'>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsam quibusdam facilis reprehenderit optio similique at error. Exercitationem autem repudiandae unde doloribus reiciendis. Fugit, ipsam maxime?
                </p>
