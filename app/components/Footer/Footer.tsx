...
const Footer = () => {
  return (
    <div className="pt-[5rem] pb-[3rem] bg-gray-900">
      ...
      <div className="w-[80%] pb-[2rem] border-b-[2px] border-b-gray-300 border-opacity-50 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem] items-center ">
        ...
        <div className="h-full">
          ...
          <div className="flex items-center text-white space-x-2">
            ...
            <h1 className="text-[20px] sm:text-[30px] font-semibold">BurgerHub</h1>
          </div>
          <p className="text-white text-opacity-60 mt-[0.4rem]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </p>
          <p className="mt-[1rem] text-white">support@sample.com</p>
          <p className="text-red-300 text-[19px] font-bold">+(123) 2354 89384</p>
        </div>
        ...
        {/* 4th path */}
        <div className="h-full">
          <h1 className="text-[23px] uppercase font-semibold mb-[2rem] text-white">Opening hours</h1>
      ...
      Copyright © 2024 <span className="text-yellow-300">BugerHub.</span> All rights reserved 
      </p>
