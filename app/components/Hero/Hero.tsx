...
import BugerImg1 from "@/public/images/b1.png";
import BugerImg2 from "@/public/images/b2.png";
    ...
    >
      ...
      <div className="w-[100%] h-[88vh] flex items-center justify-center flex-col bg-blue-950 md:clip_path">
        <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
          {/* image */}
          <Image src={BugerImg1} alt="burger" className="hidden md:block"/>
          {/* descrioption */}
          <div>
            ...
            <p className="mt-[1rem] text-white text-opacity-70 text-[18px]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Est quae facere, earum et fugiat vel iure porro
              impedit nihil molestiae praesentium rerum deleniti ullam.
            </p>
      ...
      <div className="w-[100%] h-[88vh] flex items-center justify-center flex-col bg-red-950 md:clip_path">
        <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto">
          {/* image */}
          <Image src={BugerImg2} alt="burger" className="hidden md:block"/>
          {/* descrioption */}
          <div>
