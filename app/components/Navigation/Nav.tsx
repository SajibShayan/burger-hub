    ...
    <div className="h-[12vh] bg-white border border-solid border-[#ccc]]">
      <div className="sm:w-[90%] w-[95%] mx-auto flex h-[100%] items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button className="px-6 py-2 sm:px-8 sm:py-3 text-[14px] sm:text-[16px] bg-blue-900 transition-all duration-200 hover:bg-red-600 flex items-center rounded-md space-x-2 text-white">
            <span>
