...
const Reservation = () => {
  return (
    <div
      className="pt-[5rem] relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url('/images/bg-black.jpg')]
    bg-center bg-cover
    "
    >
        {/* overlay */}
      ...
      <div className="w-[80%] relative z-[20] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]">
        ...
        <div>
            ...
            <p className="text-[17px] mt-[1rem] text-white text-opacity-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed neque labore accusamus fuga doloremque debitis natus possimus repudiandae est assumenda.</p>
            ...
            <div className="flex mt-[2rem] items-center space-x-4">
                ...
                <div>
                    ...
                    <h1 className="text-yellow-300 text-[30px] font-bold">+9808 456 783</h1>
                </div>
            </div>
        </div>
          <ReservationForm />
